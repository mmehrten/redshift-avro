...
class AvroTypeException(AvroException):
    ...
    def __init__(self, *args):
        ...
        return super().__init__(
            'The datum "{datum}" provided for "{name}" is not an example of the schema {pretty_expected}'
        )
...
class AvroOutOfScaleException(AvroTypeException):
    ...
    def __init__(self, *args):
        try:
            ...
            return super().__init__(*args)
        return super().__init__(
            "The exponent of {datum}, {exponent}, is too large for the schema scale of {scale}"
        )
