...
class SchemaCompatibilityResult:
    def __init__(
        self,
        compatibility = SchemaCompatibilityType.recursion_in_progress,
...
class ReaderWriterCompatibilityChecker:
    ...
    def check_reader_writer_record_fields(self, reader, writer, location):
        result = CompatibleResult
...
def type_mismatch(reader, writer, location):
...
def check_schema_names(reader, writer, location):
    result = CompatibleResult
...
def check_fixed_size(reader, writer, location):
    result = CompatibleResult
    actual = reader.size
...
def check_reader_enum_contains_writer_enum(reader, writer, location):
    result = CompatibleResult
...
def incompatible(incompat_type, message, location):
...
def schema_name_equals(reader, writer):
...
def lookup_writer_field(writer_schema, reader_field):
